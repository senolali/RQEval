"""Anthropic Claude API model wrapper.
...
Approximate RPM limits:
  Free / Tier-1 : ~50 RPM   →  tier='free'
  Tier-2+       : 1000 RPM  →  tier='paid'
"""
...
class AnthropicModel(BaseModel):
    """Anthropic Messages API wrapper for Claude models."""
    ...
    def _pace(self):
        """Proactive inter-request delay — primary defence against rate limits."""
