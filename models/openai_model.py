"""OpenAI API model wrapper (GPT-4o, GPT-4o-mini, GPT-4-turbo etc.)
...
Approximate RPM limits:
  Tier-1 : 500 RPM  →  tier='tier1'
  Tier-2+: 5000 RPM →  tier='tier2'
"""
...
class OpenAIModel(BaseModel):
    """OpenAI ChatCompletion API wrapper."""
    ...
    def __init__(
        ...
        rpm = _TIER_RPM.get(tier, _TIER_RPM["tier1"])
        ...
        for attempt in range(self.max_retries):
            ...
            try:
                ...
                if "rate_limit" in err or "429" in err:
                    ...
                    raise RuntimeError(f"[{self.name}] Quota/billing error: {e}")
